...
export const SIDEBAR_NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Generate Fee Installments', path: '/fees/operations', icon: FiTool },
      { name: 'Send Fees Reminders', path: '/fees/reminders', icon: FiSend },
  ...
  },
  {
    ...
    icon: FiBook,
    items: [
      { name: 'Dashboard', path: '/library', icon: FiBook },
      { name: 'Masters', path: '/library/masters', icon: FiLayers },
      { name: 'Categories', path: '/library/masters/categories', icon: FiFolder },
      // { name: 'Catalog', path: '/library/catalog', icon: FiBookOpen },
      { name: 'Books Management', path: '/library/catalog/books', icon: FiBook },
      { name: 'Members', path: '/library/members', icon: FiUsers },
      { name: 'Circulation', path: '/library/circulation', icon: FiArchive },
      { name: 'Issue Book', path: '/library/circulation/issue', icon: FiPlus },
      { name: 'Return Book', path: '/library/circulation/return', icon: FiCheckCircle },
      { name: 'Fines', path: '/library/fines', icon: FiCreditCard },
      { name: 'Acquisition', path: '/library/acquisition', icon: FiTruck },
      { name: 'Digital Library', path: '/library/digital', icon: FiMonitor },
      { name: 'Inventory', path: '/library/inventory', icon: FiPackage },
      { name: 'Reports', path: '/library/reports', icon: FiBarChart2 },
      { name: 'Settings', path: '/library/settings', icon: FiSettings },
    ],
  },
  {
    id: 'inventory',
