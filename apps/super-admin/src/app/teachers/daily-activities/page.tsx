  ...
  return (
    <DashboardLayout>
      ...
      <div className={APP_MODAL_PANEL}>
              ...
              <input type="date" value={form.activity_date} onChange={(e) => setForm({ ...form, activity_date: e.target.value })} className="w-full border rounded-lg px-3 py-2 text-sm" />
              ...
              <input placeholder="Topic covered" value={form.topic_covered} onChange={(e) => setForm({ ...form, topic_covered: e.target.value })} className="w-full border rounded-lg px-3 py-2 text-sm" />
              <input type="number" min={1} placeholder="Periods taught" value={form.periods_taught} onChange={(e) => setForm({ ...form, periods_taught: e.target.value })} className="w-full border rounded-lg px-3 py-2 text-sm" />
              ...
              <textarea placeholder="Remarks" value={form.remarks} onChange={(e) => setForm({ ...form, remarks: e.target.value })} className="w-full border rounded-lg px-3 py-2 text-sm" rows={2} />
