            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
              <div className="lg:col-span-2 bg-white border border-gray-200 rounded-xl shadow-sm p-4">
                ...
                {topTeachers.length === 0 ? (
                  <p className="text-sm text-gray-500 py-6 text-center">No teacher performance data yet</p>
                ) : (
                    ...
                    <table className="min-w-full text-sm">
                      <thead className="bg-gray-50 border-b border-gray-100">
                        <tr>
                          ...
                          <th className="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase">Activities</th>
                          <th className="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase">Syllabus</th>
                        </tr>
                      </thead>
                      <tbody className="divide-y divide-gray-100">
                        {topTeachers.map((teacher) => (
                          <tr key={String(teacher.staff_id)} className="hover:bg-gray-50">
                            ...
                            <td className="px-3 py-2 text-green-700 font-semibold">{String(teacher.score)}</td>
              ...
              <div className="space-y-4">
                <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-4">
                  ...
                  <Link
                    href="/payroll"
                    className="mt-4 inline-flex text-sm text-primary-600 hover:underline"
                  >
                    Open payroll
                  </Link>
                </div>
                  ...
                  <div className="flex items-start justify-between gap-3 py-2 border-b border-gray-100 last:border-b-0">
                    <div>
                      ...
                      <p className="text-xs text-gray-500">
                        {String(leave.leave_type_name || 'Leave')} · {formatDate(leave.start_date)} – {formatDate(leave.end_date)}
                      </p>
                    </div>
                    <span
