  ...
  return (
    <div className={`fixed top-0 bottom-0 right-0 bg-black bg-opacity-50 z-[60] transition-all duration-300 ${
      ...
      <div className="bg-white shadow-2xl w-full h-full overflow-y-auto">
        ...
        <div className="px-4 py-2 sm:px-6 sm:py-3 border-b flex justify-between items-center sticky top-0 bg-white z-10 print:hidden">
        ...
        <div className="flex justify-end gap-3 p-4 sm:p-6 border-t sticky bottom-0 bg-white print:hidden">
          <button
            onClick={onClose}
