...
import RupeeIcon from '@/features/parent-portal/components/RupeeIcon'
import { useSchoolBranding } from '@/features/parent-portal/contexts/SchoolBrandingContext'
        ...
        <div className={`${PAGE_CONTAINER} py-2 sm:py-2.5`}>
          <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between sm:gap-3">
            ...
            <div className="flex items-center gap-1.5 shrink-0">
              <button
                type="button"
                onClick={() => router.push(parentRoute('/notifications'))}
      ...
      <div className={`${PAGE_CONTAINER} py-3 sm:py-4 pb-6 flex flex-col gap-3 sm:gap-4`}>
        ...
        <section className="portal-profile-banner rounded-lg shadow-sm">
          <div className="flex flex-row items-center gap-2.5 sm:gap-3 px-3.5 sm:px-4 py-2.5 sm:py-3">
            ...
            <button
              type="button"
              onClick={() => router.push(parentRoute(`/profile/${studentId}`))}
          ...
          <div className={SECTION_STACK}>
            <section className="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-5 gap-2.5 sm:gap-3 auto-rows-fr">
              <StatusCard
                ...
                onClick={() => router.push(parentRoute(`/attendance/${studentId}`))}
              />
              <StatusCard
                title="Pending Fees"
                ...
                chip="warning"
                actionLabel="Pay Now"
                onClick={() => router.push(parentRoute(`/fees/${studentId}`))}
              />
              <StatusCard
                title="Homework Due"
                ...
                onClick={() => router.push(parentRoute(`/homework/${studentId}`))}
              />
              <StatusCard
                title="Upcoming Exam"
                ...
                chip="info"
                actionLabel="View Details"
                onClick={() => router.push(parentRoute('/results'))}
              />
              <StatusCard
            ...
            <section className={`grid grid-cols-1 lg:grid-cols-2 ${GRID_GAP_LG}`}>
              ...
              <PanelCard
                title="Fee Summary"
                actionLabel="View Details"
                onAction={() => router.push(parentRoute(`/fees/${studentId}`))}
              >
            ...
            <section className={`grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 ${GRID_GAP_LG}`}>
              ...
              <InfoCard
                ...
                icon={FiBook}
                onAction={() => router.push(parentRoute(`/homework/${studentId}`))}
              ...
              <InfoCard
                ...
                actionLabel="View All"
                icon={FiBell}
                onAction={() => router.push(parentRoute('/notifications'))}
              ...
              <InfoCard
                ...
                onAction={() => router.push(parentRoute('/calendar'))}
              >
            ...
            <section>
              ...
              <div className="flex flex-wrap gap-1.5">
                <QuickPill label="Apply Leave" icon={FiCalendar} onClick={() => router.push(parentRoute(`/attendance/${studentId}`))} />
                <QuickPill label="Fee Payment" icon={RupeeIcon} onClick={() => router.push(parentRoute(`/fees/${studentId}`))} />
                <QuickPill label="Homework" icon={FiBook} onClick={() => router.push(parentRoute(`/homework/${studentId}`))} />
                <QuickPill label="Download Receipt" icon={FiFileText} onClick={() => router.push(parentRoute(`/fees/${studentId}`))} />
                <QuickPill label="Report Card" icon={FiAward} onClick={() => router.push(parentRoute(`/grades/${studentId}`))} />
                <QuickPill label="Profile" icon={FiUser} onClick={() => router.push(parentRoute(`/profile/${studentId}`))} />
              </div>
            </section>
          </div>
        ) : (
