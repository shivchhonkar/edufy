...
export default function SimpleRecordPaymentModal({ 
  ...
  return (
    ...
    }`} style={{ width: sidebarCollapsed ? 'calc(100vw - 80px)' : 'calc(100vw - 224px)', height: 'calc(100vh)' }}>
      <div className="bg-white shadow-2xl w-full h-full overflow-y-auto flex flex-col rounded-tl-xl" style={{ height: 'calc(100vh)' }}>
        {/* Header */}
